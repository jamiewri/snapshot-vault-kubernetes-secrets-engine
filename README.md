...
deploying kubernetes namespaces
namespace/app created
namespace/infra created
namespace/tfc created
```
...
Installing Service accounts and ClusterRoleBindings
serviceaccount/vault-cluster-admin created
clusterrolebinding.rbac.authorization.k8s.io/vault-cluster-admin created
```
...
NAME: vault
LAST DEPLOYED: Wed Nov 23 11:19:47 2022
NAMESPACE: infra
STATUS: deployed
REVISION: 1
NOTES:
...
- Set env var `VAULT_ADDR` to the address of Vault.
